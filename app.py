...
# Load model
model = pickle.load(open(r'C:\Users\imadi\pycharm new\Heart Disease Prediction\Models\rf_classifier.pkl', 'rb'))
scaler = pickle.load(open(r'C:\Users\imadi\pycharm new\Heart Disease Prediction\Models\scaler.pkl', 'rb'))
